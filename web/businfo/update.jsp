...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>BusInfo Update    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>busInfo list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/businfo_update.action">
				  <div class="control-group">
				    <label class="control-label" for="inputBus_id">bus_id</label>
				    <div class="controls">
				      <input type="text" id="inputBus_id" name="busInfo.bus_id" value="${busInfo.bus_id}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBus_number">bus_number</label>
				    <div class="controls">
				      <input type="text" id="inputBus_number" name="busInfo.bus_number" value="${busInfo.bus_number}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBus_color">bus_color</label>
				    <div class="controls">
				      <input type="text" id="inputBus_color" name="busInfo.bus_color" value="${busInfo.bus_color}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputSeat_count">seat_count</label>
				    <div class="controls">
				      <input type="text" id="inputSeat_count" name="busInfo.seat_count" value="${busInfo.seat_count}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBus_fullname">bus_fullname</label>
				    <div class="controls">
				      <input type="text" id="inputBus_fullname" name="busInfo.bus_fullname" value="${busInfo.bus_fullname}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBus_shortname">bus_shortname</label>
				    <div class="controls">
				      <input type="text" id="inputBus_shortname" name="busInfo.bus_shortname" value="${busInfo.bus_shortname}">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
