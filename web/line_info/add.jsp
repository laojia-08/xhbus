...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Line_info Add    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>line_info list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/line_info_add.action">
				  <div class="control-group">
				    <label class="control-label" for="inputLine_id">line_id</label>
				    <div class="controls">
				      <input type="text" id="inputLine_id" name="line_info.line_id">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputLine_fullname">line_fullname</label>
				    <div class="controls">
				      <input type="text" id="inputLine_fullname" name="line_info.line_fullname">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputLine_shortname">line_shortname</label>
				    <div class="controls">
				      <input type="text" id="inputLine_shortname" name="line_info.line_shortname">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBus_id">bus_id</label>
				    <div class="controls">
				      <input type="text" id="inputBus_id" name="line_info.bus_id">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_id">station_id</label>
				    <div class="controls">
				      <input type="text" id="inputStation_id" name="line_info.station_id">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_order">station_order</label>
				    <div class="controls">
				      <input type="text" id="inputStation_order" name="line_info.station_order">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputLine_stationtime">line_stationtime</label>
				    <div class="controls">
				      <input type="text" id="inputLine_stationtime" name="line_info.line_stationtime">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
