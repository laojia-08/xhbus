...
<title>Attachment_info Add</title>
...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Attachment_info Add    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>attachment_info list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/attachment_info_add.action">
				  <div class="control-group">
				    <label class="control-label" for="inputAttachment_id">attachment_id</label>
				    <div class="controls">
				      <input type="text" id="inputAttachment_id" name="attachment_info.attachment_id">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputAttachment_fullname">attachment_fullname</label>
				    <div class="controls">
				      <input type="text" id="inputAttachment_fullname" name="attachment_info.attachment_fullname">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputAttachment_address">attachment_address</label>
				    <div class="controls">
				      <input type="text" id="inputAttachment_address" name="attachment_info.attachment_address">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputAttachment_type">attachment_type</label>
				    <div class="controls">
				      <input type="text" id="inputAttachment_type" name="attachment_info.attachment_type">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputAttachment_moudle">attachment_moudle</label>
				    <div class="controls">
				      <input type="text" id="inputAttachment_moudle" name="attachment_info.attachment_moudle">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
