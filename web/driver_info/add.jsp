...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Driver_info Add    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>driver_info list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/driver_info_add.action">
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_id">dirver_id</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_id" name="driver_info.dirver_id">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_name">dirver_name</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_name" name="driver_info.dirver_name">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_sex">dirver_sex</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_sex" name="driver_info.dirver_sex">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_birthday">dirver_birthday</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_birthday" name="driver_info.dirver_birthday">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_age">dirver_age</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_age" name="driver_info.dirver_age">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_telephone">dirver_telephone</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_telephone" name="driver_info.dirver_telephone">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDirver_weChat">dirver_weChat</label>
				    <div class="controls">
				      <input type="text" id="inputDirver_weChat" name="driver_info.dirver_weChat">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
