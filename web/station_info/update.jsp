...
<title>Station_info Update</title>
...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Station_info Update    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>station_info list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/station_info_update.action">
				  <div class="control-group">
				    <label class="control-label" for="inputStation_id">station_id</label>
				    <div class="controls">
				      <input type="text" id="inputStation_id" name="station_info.station_id" value="${station_info.station_id}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_fullname">station_fullname</label>
				    <div class="controls">
				      <input type="text" id="inputStation_fullname" name="station_info.station_fullname" value="${station_info.station_fullname}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_shortname">station_shortname</label>
				    <div class="controls">
				      <input type="text" id="inputStation_shortname" name="station_info.station_shortname" value="${station_info.station_shortname}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_x">station_x</label>
				    <div class="controls">
				      <input type="text" id="inputStation_x" name="station_info.station_x" value="${station_info.station_x}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_y">station_y</label>
				    <div class="controls">
				      <input type="text" id="inputStation_y" name="station_info.station_y" value="${station_info.station_y}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputStation_description">station_description</label>
				    <div class="controls">
				      <input type="text" id="inputStation_description" name="station_info.station_description" value="${station_info.station_description}">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
